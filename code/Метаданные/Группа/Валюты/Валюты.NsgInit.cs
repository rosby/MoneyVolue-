...
namespace Val.Метаданные.Группа
{
	...
	ДатаВремя.GroupName = "";
	ДатаВремя.Guid = NsgService.StringToGuid("4415c01d-b2ca-4001-b492-700d925700d6");
