...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "cdf126a0-729e-4fb2-a256-efe73c1c6687")]
    public partial class НастройкиКаналаОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("cdf126a0-729e-4fb2-a256-efe73c1c6687"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("6f00575c-af0d-4375-b293-347f2389a9de");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("03a5a828-ea83-4161-9f9b-753983e34231");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("4015f509-1a99-4556-b074-a2f40de28f30");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("0e4451f1-7c04-475a-965e-6284f833baec");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ef44ca9e-a392-4f25-9714-e35ee9670012");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("78da7543-936c-4b37-a58b-ec42b2d9f188");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b3849b1e-415e-4806-8a5f-2e4f0bb94fc2");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("58a418b8-3863-4d65-b6dd-3c4f17740f98");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("a3ef3409-d356-4cd7-9dc0-8d6df9fe157b");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("bf18b839-3bf6-40e1-86ce-cdb4e631091f");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("8ff12eb2-0947-47b8-98ea-02a8ea436549");
	...
	ТипОбмена.GroupName = "";
	ТипОбмена.Guid = NsgService.StringToGuid("fd04e164-e75a-45aa-887f-77ace69adde9");
	...
	ПараметрыОбмена.Guid = NsgService.StringToGuid("f251f817-9e5b-422b-b4a7-316733b94951");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("cdf126a0-729e-4fb2-a256-efe73c1c6687");
	DefaultSortingName = "";
