...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "583e4000-1f9d-49a7-abae-d512521d8789")]
	...
	Создан.GroupName = "";
	Создан.Guid = NsgService.StringToGuid("0cd24c5c-93c7-466f-9e7f-0772b7c4f9f6");
	...
	Сохранен.GroupName = "";
	Сохранен.Guid = NsgService.StringToGuid("597fb84f-d1dc-43ab-bf7d-e06055373c81");
	...
	Удален.GroupName = "";
	Удален.Guid = NsgService.StringToGuid("5a30ed12-c4f6-4a78-a878-bf1e5fcfd0fe");
	...
	Шаблон.GroupName = "";
	Шаблон.Guid = NsgService.StringToGuid("5416640b-4b0a-4029-83b1-192d213971ee");
	...
	Проведен.GroupName = "";
	Проведен.Guid = NsgService.StringToGuid("0d043ddc-2c8c-4225-804b-e3ec894c837f");
	...
	Предопределенный.Guid = NsgService.StringToGuid("71e0e466-b4b7-4d05-b3b8-71638a6f7cac");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("583e4000-1f9d-49a7-abae-d512521d8789");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("583e4000-1f9d-49a7-abae-d512521d8789"));
            if (obj == null)
