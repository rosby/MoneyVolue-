...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataAssemblyObject", Guid = "a9bd851e-8ff6-47c7-a502-f6b35786e624")]
    public partial class DataAssemblyObject : NsgSoft.DataObjects.NsgDataAssemblyObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a9bd851e-8ff6-47c7-a502-f6b35786e624"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("e1932a2b-f11a-4c3c-b3a5-5c1bdd88410b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1cd54cda-f6d2-4905-a67a-87e891d647a3");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("735ebe75-c501-4fc6-9ca0-1e24b683999f");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("6290ed28-7741-4f90-9798-e71929c01c7b");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("9ad8eb4b-148a-4eac-b65b-be8cb96aca44");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("6241e502-f373-447c-90a0-a3241fda0775");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("42001a65-bbdf-487a-be52-2a9f95a107eb");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e8d3ea7c-6c91-4cd9-919e-69f6b551ea87");
	...
	_AsmName.GroupName = "";
	_AsmName.Guid = NsgService.StringToGuid("61deb682-c9ea-4971-bf02-82e212ff5bdb");
	...
	_AsmVersion.Guid = NsgService.StringToGuid("074a7c86-e467-4234-a44f-6f4c410abbb3");
	...
	_AsmHash.GroupName = "";
	_AsmHash.Guid = NsgService.StringToGuid("57b084ad-95de-485c-986a-0926cc1b6cdb");
	...
	_AsmData.GroupName = "";
	_AsmData.Guid = NsgService.StringToGuid("4fe176e5-43cc-4aa3-a226-6224eef9078d");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("ea1883c4-8ae5-431d-9686-4f1f9f68e505");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("a9bd851e-8ff6-47c7-a502-f6b35786e624");
	DefaultSortingName = "";
