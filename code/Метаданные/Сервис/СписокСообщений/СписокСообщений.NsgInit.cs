...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "8eccb162-98b2-4bf1-a3d4-1a4b81d48680")]
    public partial class СписокСообщений : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8eccb162-98b2-4bf1-a3d4-1a4b81d48680"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("34accf27-b9b7-4889-80f8-ef66d7d1acdd");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("81a004ca-1c65-4423-a3d6-200a709fbd62");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("5f6e6e31-3c83-40aa-bc81-f4457b65ff6e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("1cd538ca-d42b-4161-b2c6-127f707e977b");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ab99b4a4-5be2-436b-af69-30168fef11b3");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("5e2c6a4f-80de-4708-99f5-261dc4d22371");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("046adc1a-aadc-447b-8822-f20e07073d32");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("7d40cef7-d02b-464f-8011-ce3d0775238f");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0f31a87c-b454-44d9-af2e-4e29e175eb4d");
	...
	ТипСообщения.Guid = NsgService.StringToGuid("4430ca63-14e5-4956-9f94-036771c31aff");
	...
	ТекстСообщения.Guid = NsgService.StringToGuid("03118c5b-ef7f-4299-bcfe-abb4a15108fb");
	...
	ОбъектСообщения.Guid = NsgService.StringToGuid("1dd07a5d-2793-4e1a-9a67-fcb4e7193c4f");
	...
	АдресатСообщения.Guid = NsgService.StringToGuid("bd95fce7-80c0-4a63-9734-0a7e2270b4ec");
	...
	АктуальностьСообщения.Guid = NsgService.StringToGuid("d08a8f2b-0d33-487c-aa41-fe734fc3d94f");
	...
	ВремяПоявленияСообщения.Guid = NsgService.StringToGuid("1f290591-309e-47ea-b7c9-e3f5b1fdf1b3");
	...
	СтатусСообщения.Guid = NsgService.StringToGuid("337b8bc7-5ba8-42ee-b3dc-d4d37a74e020");
	...
	АвторСообщения.Guid = NsgService.StringToGuid("c1370af4-fc85-4df9-914a-c9da01cb84d2");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("dcf8ee79-18bd-47f4-83e6-d697ffa5e33a");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("566d8398-0a76-46d5-9752-3d6ceb149d39");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("8eccb162-98b2-4bf1-a3d4-1a4b81d48680");
	DefaultSortingName = "";
