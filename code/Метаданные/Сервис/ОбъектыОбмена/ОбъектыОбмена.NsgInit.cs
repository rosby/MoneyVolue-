...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "50eb5c11-e785-4ddb-a891-bca0223d993c")]
    public partial class ОбъектыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("50eb5c11-e785-4ddb-a891-bca0223d993c"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("ee82c6f9-4f35-48b2-9efb-beb86e9780cc");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f887a5c7-dcb6-47b0-b5c0-96ed7f460ef4");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("adc2ee11-55a1-44b7-9a46-cac179d1416e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("f2081e7e-60ca-4c0e-8b85-f6e8bfe1d469");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("51cc048e-3f21-4942-8193-eae32f5266e9");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("a644ad0a-0b59-448a-aa58-2e16aa7c3a75");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b201442f-3de2-454c-8f34-8256a111e286");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("b9412642-fd01-458f-be9f-26980342ff17");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("6c0d0930-541b-4c12-b21c-f7a9c859e05a");
	...
	ОбъектОбмена.Guid = NsgService.StringToGuid("13577175-1471-4794-acf9-36c1ca67131a");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("3e46026d-40c1-4ca3-a479-5441844af195");
	...
	НомерОбмена.Guid = NsgService.StringToGuid("b36f6a02-55f0-4b0a-8f32-0cf4bf56c6a0");
	...
	Name = "ОбъектыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("50eb5c11-e785-4ddb-a891-bca0223d993c");
	DefaultSortingName = "";
