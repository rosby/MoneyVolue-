...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "7668c909-da5f-4a1f-8798-f1de0a6729a4")]
    public partial class ПечатныеФормы : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("7668c909-da5f-4a1f-8798-f1de0a6729a4"));
            if (obj == null)
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("88d555ac-7c49-4422-b5ec-0609cb2a4cfe");
	...
	КонецПериода.Guid = NsgService.StringToGuid("88d83dd9-8c7c-4c74-aa55-39981387eae8");
	...
	Идентификатор.Guid = NsgService.StringToGuid("4f5dac9b-447f-44ab-8cf9-fc994e4650ec");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("32154235-090c-4999-bd88-b818d6ca45ed");
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("69d14fcc-f172-4272-9bb2-0f50bf9068a4");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("a0ecbf54-6c0f-45a9-a1a2-60be46cd5213");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("37ada617-2059-4780-aafa-f61717098658");
	...
	Обработка.GroupName = "";
	Обработка.Guid = NsgService.StringToGuid("32bde698-46cb-4624-9ebb-8eacc88f0331");
	...
	Наименование.Guid = NsgService.StringToGuid("593743d7-bc42-4d49-b0ac-2e135cda775a");
	...
	ПечатнаяФорма.Guid = NsgService.StringToGuid("a05abb92-a81f-4b52-b987-05fe9ecc382b");
	...
	Условие.GroupName = "";
	Условие.Guid = NsgService.StringToGuid("6662ac5e-6e86-429b-ba6e-66bfb62b2a50");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("762eca67-16d2-49cb-ae2c-86fd57a1e9bb");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("c769c82d-5c27-48aa-a78c-43f3b411fdf7");
	...
	Name = "ПечатныеФормы";
	Visible = true;
	Guid = NsgService.StringToGuid("7668c909-da5f-4a1f-8798-f1de0a6729a4");
	DefaultSortingName = "";
