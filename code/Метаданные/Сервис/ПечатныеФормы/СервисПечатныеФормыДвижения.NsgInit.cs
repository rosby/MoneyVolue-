...
namespace Val.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "b80dfed3-72a7-4363-9c09-f33ffb7709ef")]
    public partial class СервисПечатныеФормыДвижения : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b80dfed3-72a7-4363-9c09-f33ffb7709ef"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("b79378cc-290c-42ea-8bd1-d844e8117288");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f5e03e69-7232-4ce0-90fa-8c9fd5a143f3");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("afc460f3-acb9-4ac6-ae91-53ed15b3f923");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("b80dfed3-72a7-4363-9c09-f33ffb7709ef");
	DefaultSortingName = "";
