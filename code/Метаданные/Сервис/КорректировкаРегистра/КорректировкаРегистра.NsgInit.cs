...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataRegisterCorrection", Guid = "81c6d699-ec5b-4b38-bd72-5cb645ea528c")]
    public partial class КорректировкаРегистра : NsgSoft.DataObjects.NsgDataRegisterCorrection
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("81c6d699-ec5b-4b38-bd72-5cb645ea528c"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("eebbe87b-e0f4-4968-be2c-5d711b067c3b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a00cdb07-f1eb-4986-832b-cd1b229fcf11");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("91438831-867e-4b4f-8fa4-5b5f3febda23");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b065b73e-9a2b-4b67-aa5f-ae1269c47aa0");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("90c312bd-a418-43a6-9091-915c45c3f293");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("8fb4cc2d-a9ff-4bd6-ae32-e9d999969590");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("b866b2f2-7cc3-4f19-a8e7-7557358d7223");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("0ae167f4-4b78-4795-8d6d-24869532511d");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("b6bd57fc-38fa-46ee-947c-cb330a3876c8");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("b1c8aeb4-f382-433a-8803-2688c1172107");
	...
	Регистр.GroupName = "";
	Регистр.Guid = NsgService.StringToGuid("0bcbc5db-583c-4b66-affd-8356a6588c8f");
	...
	Операция.GroupName = "";
	Операция.Guid = NsgService.StringToGuid("477157b0-bfdc-4f9f-bcd0-ef8f8ac8aa3e");
	...
	ДатаНачалаДействия.Guid = NsgService.StringToGuid("58c18318-ddb9-4ae7-9f43-fbe6526cebdf");
	...
	ДатаОкончанияДействия.Guid = NsgService.StringToGuid("35a621cd-8288-4efc-a9b8-e0876d958f5e");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("81c6d699-ec5b-4b38-bd72-5cb645ea528c");
	DefaultSortingName = "";
