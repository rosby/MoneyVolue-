...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataServerJob", Guid = "f08247c9-823f-4587-9510-3ec9b713a5b6")]
    public partial class СервернаяЗадача : NsgSoft.DataObjects.NsgDataServerJob
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f08247c9-823f-4587-9510-3ec9b713a5b6"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("bebfc13e-a6c6-4d01-b9ab-7ba43a13f60d");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("066e5cea-3442-4c6a-b88f-196566408554");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("228a6c25-46b0-4c21-aa70-a655e8030e76");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("c02a28da-b232-4110-b553-b5d2ab6d163f");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("69d15e04-c125-44e4-9a67-791a2e27fb17");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("11ef8eca-aff3-4514-9d3d-fe2e214f77ec");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("59a3c641-635a-4ad6-a829-c85a8b2868aa");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("029778cb-f670-4560-aa21-85d5d7a79a6f");
	...
	ДатаЗапускаЗадания.Guid = NsgService.StringToGuid("0873dc9d-6888-4779-9e45-77ee91a9c9b0");
	...
	ДатаНачалаИсполнения.Guid = NsgService.StringToGuid("e9a80575-c5dc-4a7a-9bda-4b940b918580");
	...
	ДатаОкончанияИсполнения.Guid = NsgService.StringToGuid("822204fd-61ac-4909-9da2-36cd925d0b25");
	...
	ПриоритетЗадания.Guid = NsgService.StringToGuid("e0a90213-57c2-4a66-b7b4-b6bc5877759e");
	...
	ОбрабатываемыйОбъект.Guid = NsgService.StringToGuid("f76c88d7-d5f7-4a8e-8d43-27b5af463e8b");
	...
	ТипОбрабатываемогоОбъекта.Guid = NsgService.StringToGuid("e3aba370-b942-4484-89da-aabf0418fa6c");
	...
	ДействиеНадОбъектом.Guid = NsgService.StringToGuid("7671292b-a3dd-4b08-b645-ad9c7503cb8a");
	...
	УведомлятьАвтораОВыполнении.Guid = NsgService.StringToGuid("24401b51-8723-4c70-8580-c6d9cf837398");
	...
	АвторЗадания.Guid = NsgService.StringToGuid("e5a0354e-6cd6-4ef7-ab3e-3e8a9020e9dd");
	...
	ПользовательДляУведомления.Guid = NsgService.StringToGuid("51dbbfc0-3ff0-4bd8-88be-f47305f3d3ec");
	...
	КоличествоПопыток.Guid = NsgService.StringToGuid("4617e03e-d51d-4261-bc95-e8d27fedc534");
	...
	Настройки.GroupName = "";
	Настройки.Guid = NsgService.StringToGuid("80d96a5d-8214-4fe2-9da9-f00005e57b3f");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("62452fab-2cd0-4d5c-8429-c888278c6fe2");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("f08247c9-823f-4587-9510-3ec9b713a5b6");
	DefaultSortingName = "";
