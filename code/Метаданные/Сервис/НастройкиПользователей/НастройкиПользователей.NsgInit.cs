...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "f5c947d8-cee8-423b-bed2-59f7c16f55b1")]
    public partial class НастройкиПользователей : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f5c947d8-cee8-423b-bed2-59f7c16f55b1"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("f60a877d-b337-4b8d-b516-906083d31b90");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("64630bbb-8b93-47c5-b213-edd45ef7f3c8");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("bf04a398-be0b-433d-aedf-c353969f6946");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("d19d2b35-1394-4deb-9a8e-f44df34fd9dc");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("735f4741-5a02-4789-8152-36ed485e6405");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("4dd95c9b-33f0-4dbd-8a6a-6f54b62a62f4");
	...
	Наименование.Guid = NsgService.StringToGuid("ba6a0aba-412b-4fdb-a212-a70f71486a62");
	...
	XmlText.GroupName = "";
	XmlText.Guid = NsgService.StringToGuid("be9255ba-c7b6-4ad4-b155-6bca6f2b1f33");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("f5c947d8-cee8-423b-bed2-59f7c16f55b1");
	DefaultSortingName = "";
