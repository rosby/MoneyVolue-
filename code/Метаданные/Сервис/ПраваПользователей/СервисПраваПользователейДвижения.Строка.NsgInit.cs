...
{
    [NsgTypeName("NsgDataTableRow", Guid = "fefbc1b6-bab3-4267-a436-37eb9f32f7a1")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fefbc1b6-bab3-4267-a436-37eb9f32f7a1"));
            if (obj == null)
                obj = new Строка();
