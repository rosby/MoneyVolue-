...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "b64d6759-a27a-40d9-a34d-e67320c953a8")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b64d6759-a27a-40d9-a34d-e67320c953a8"));
            if (obj == null)
                obj = new ТипыОбмена();
	...
	Идентификатор.Guid = NsgService.StringToGuid("e7be3394-0322-44e2-8d6d-efcdb52bb4a6");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1b3b8b12-31a5-482d-bf4a-5d5f7fe07d0e");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("47b9ce2b-7831-4a32-b5f9-21297b2df15e");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("5f660258-6c21-4b7a-9a1b-7c258abab942");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ae528fdc-3f76-4321-b428-d86780a07f2b");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("04db05c1-e96d-4e80-bc59-3fd81a184c86");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("39b8040c-9eac-4343-97a8-b41bc5293246");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("ae4660e2-9ceb-4afc-b47a-dd0d9ab0edab");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("99b7fb6e-171e-4a63-997b-8a4d764f712b");
	...
	Наименование.Guid = NsgService.StringToGuid("35e0abae-d5ad-48a0-b530-80df77c30440");
	...
	Файл.Guid = NsgService.StringToGuid("f7c07f67-5a22-47b2-983a-50fb8df1dfa9");
	...
	Email.Guid = NsgService.StringToGuid("4a913705-db83-4605-ad2c-8821831b773e");
	...
	SQL.Guid = NsgService.StringToGuid("1733aee2-1cfd-4a15-ada6-df77b8d609c8");
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("b64d6759-a27a-40d9-a34d-e67320c953a8");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("b64d6759-a27a-40d9-a34d-e67320c953a8"), NsgService.StringToGuid("f7c07f67-5a22-47b2-983a-50fb8df1dfa9"));
            }
        }
        ...
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("b64d6759-a27a-40d9-a34d-e67320c953a8"), NsgService.StringToGuid("4a913705-db83-4605-ad2c-8821831b773e"));
            }
        }
        ...
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("b64d6759-a27a-40d9-a34d-e67320c953a8"), NsgService.StringToGuid("1733aee2-1cfd-4a15-ada6-df77b8d609c8"));
            }
        }
