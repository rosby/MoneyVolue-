...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "a734cac7-8959-4cc2-89aa-d79fd9e75ed8")]
    public partial class РольПользователяМеню : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a734cac7-8959-4cc2-89aa-d79fd9e75ed8"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("7601c282-09ed-41fb-a8a6-d12d6ece97b8");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("d116f34e-48bd-4085-8fbd-803e5edf90e0");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("567b51e8-dc49-4c3c-aa58-15fdaf98d976");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("3655fd2a-d21d-49de-84b0-8ff1ddf6e2d3");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("483847a2-95d3-476d-95ba-84c03fee8cb3");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("9535fdc2-0bb5-47ce-aa87-11f0b852d0ec");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("440a2a02-0913-483e-988b-4facb2c8c458");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("c1f943c9-0395-4975-a891-8d7fac935704");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0ed7f775-64e1-4a07-a645-4046056bd46f");
	...
	Наименование.Guid = NsgService.StringToGuid("f6d5233d-90b8-4218-8271-f2ca5c5df090");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("fc57d3d4-2532-43aa-b0a2-74d8627f6dfc");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("a734cac7-8959-4cc2-89aa-d79fd9e75ed8");
	DefaultSortingName = "";
