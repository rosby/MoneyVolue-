...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "444e6ffb-a04c-4c82-af16-70cce67bf16b")]
    public partial class СервисноеОбслуживание : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("444e6ffb-a04c-4c82-af16-70cce67bf16b"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("19d185ed-3c5f-499a-b2bb-f447f86286f5");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8cab364c-f1ab-44d5-86c9-429f8302005a");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("54e7c369-1696-483b-b631-f799dce08b94");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("444e6ffb-a04c-4c82-af16-70cce67bf16b");
	DefaultSortingName = "";
