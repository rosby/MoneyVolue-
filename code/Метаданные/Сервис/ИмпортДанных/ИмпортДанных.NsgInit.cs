...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "a3605ce3-4380-4e9a-a753-13f6b26c623d")]
    public partial class ИмпортДанных : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a3605ce3-4380-4e9a-a753-13f6b26c623d"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("d56f519a-c717-4114-b6bd-f7239eff1afc");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("890bbc4a-53df-4c8f-85d5-c805f387d3f6");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("b337d090-ed97-4da3-8d75-89c6cd215e17");
	...
	Name = "ИмпортДанных";
	Visible = true;
	Guid = NsgService.StringToGuid("a3605ce3-4380-4e9a-a753-13f6b26c623d");
	DefaultSortingName = "";
