...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "b613d9a0-0b2c-4c97-9872-3459818410e0")]
    public partial class ОбщийЖурнал : NsgSoft.DataObjects.NsgDataDocument
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b613d9a0-0b2c-4c97-9872-3459818410e0"));
            if (obj == null)
                obj = new ОбщийЖурнал();
	...
	Наследник.FilterForConfigurator = "Сервис.КорректировкаРегистра,Сервис.СервернаяЗадача";
	...
	Наследник.GroupName = "";
	Наследник.Guid = NsgService.StringToGuid("e715bd2a-b0db-42ca-aac1-712148fc7f9d");
	...
	Идентификатор.Guid = NsgService.StringToGuid("c18b6a76-9439-4105-9bcf-094eac4c9550");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f5ada5b4-44f7-4221-93af-ccaf0c5c1070");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("9d1f8e8c-77bc-4a45-a839-2f1b0054b057");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("1390dc18-a4f4-480f-82b1-f4a413a252ec");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("237aaf9c-954a-418a-91d6-8c9bd21d2869");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("47912925-db15-45f0-b238-539cc9cfe2a0");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("1cddbee4-1f92-4f12-a4eb-b4896d369096");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("afc528c4-6dfc-4876-9576-be15a4de9352");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("da202ff8-d28a-400f-a29e-2868f04c4c34");
	...
	Name = "ОбщийЖурнал";
	Visible = true;
	Guid = NsgService.StringToGuid("b613d9a0-0b2c-4c97-9872-3459818410e0");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        [NsgReferentsFilterAttribute("Сервис.КорректировкаРегистра,Сервис.СервернаяЗадача")]
