...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "1cd8e8ff-1303-4f09-8f3a-25b184544dd6")]
    public partial class ТаблицаЭлементаМенюПользователя : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1cd8e8ff-1303-4f09-8f3a-25b184544dd6"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("a020faf4-8283-4086-a20a-0955027900d4");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f01b683f-ccba-4aae-a938-2ba3e6ceda9a");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("94a6268b-8503-497d-af31-5a8f1e61df5a");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("77a9cb1d-6e59-4ccd-9bfa-fe4be6a7823f");
	...
	РольПользователя.Guid = NsgService.StringToGuid("3298c988-6541-4d3d-a893-e57062026244");
	...
	Активность.Guid = NsgService.StringToGuid("ab5e5c6e-e730-4846-9368-b0270037e110");
	...
	Открыть.GroupName = "";
	Открыть.Guid = NsgService.StringToGuid("c4335b94-d7dd-417e-b7d0-acb0ac2917ab");
	...
	СоздатьНовый.Guid = NsgService.StringToGuid("ab886094-cd69-48a9-90e6-604528c5c270");
	...
	Visible = false;
	Guid = NsgService.StringToGuid("1cd8e8ff-1303-4f09-8f3a-25b184544dd6");
	DefaultSortingName = "";
