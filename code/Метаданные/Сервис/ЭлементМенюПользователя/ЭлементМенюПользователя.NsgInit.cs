...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "e8f3674a-8af9-41e3-8c0f-4c16d0e7e971")]
    public partial class ЭлементМенюПользователя : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("e8f3674a-8af9-41e3-8c0f-4c16d0e7e971"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("d3350e5d-12ca-48ff-ba87-2ac03bfb39ab");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1681b34d-1b5f-4ca6-a430-df10ce0ce089");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("64a941c6-8009-41af-8e2d-421a74591fea");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("83b33317-5b7f-4f3d-943c-c8868d81c5bc");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("c0c73aa6-83c0-4ff1-8ca0-d47fcf34dd41");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("c59f037f-4adb-4e69-a41e-ee4f0a00f7d2");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b920eaf1-55e2-4417-9e3b-4bd45099cf1e");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("2beca4b7-df7e-4c49-864d-011977117b90");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("aae26b59-c8f8-4f9f-9c4e-67b7468ffd7b");
	...
	Наименование.Guid = NsgService.StringToGuid("d3900de4-2653-408f-b643-e619a2998606");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("374e1779-2a4a-4dc3-a8ed-dc6b08dc4ffc");
	...
	Картинка.GroupName = "";
	Картинка.Guid = NsgService.StringToGuid("a2aa3564-64d0-4cd4-b054-44182c9a8b80");
	...
	БольшаяИконка.Guid = NsgService.StringToGuid("c2cf57c4-2432-442d-9979-2863ce70a4d6");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("0145ff83-0022-4e24-a130-686e947cf9fd");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("e8f3674a-8af9-41e3-8c0f-4c16d0e7e971");
	DefaultSortingName = "";
