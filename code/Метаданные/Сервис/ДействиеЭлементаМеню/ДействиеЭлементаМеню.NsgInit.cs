...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "e665d613-dcff-4f3c-a611-2eabb0dc7b75")]
	...
	Открыть.GroupName = "";
	Открыть.Guid = NsgService.StringToGuid("76c99347-5e8a-4728-8c30-aa58713c813f");
	...
	СоздатьНовый.Guid = NsgService.StringToGuid("f807f954-2aba-495a-b2e6-cfb1d9e4135e");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("e665d613-dcff-4f3c-a611-2eabb0dc7b75");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("e665d613-dcff-4f3c-a611-2eabb0dc7b75"));
            if (obj == null)
