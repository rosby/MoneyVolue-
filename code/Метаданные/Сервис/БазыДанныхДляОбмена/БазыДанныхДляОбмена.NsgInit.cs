...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "81589896-f9a8-475e-acd6-b0975a768f5f")]
    public partial class БазыДанныхДляОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("81589896-f9a8-475e-acd6-b0975a768f5f"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("93af6eed-a08e-4583-802d-fc4df81e7a62");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("836e1ee8-11b6-48da-8300-317ba1ea5f73");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("61b51b9e-410e-4384-8f11-0c5d8f176ad0");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("edb90e7c-3875-41f5-9e74-560232992875");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("6d16a5bc-cda9-4ba3-ad65-40fc64de0f9b");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("e01ed6b7-f53e-4400-be1b-92622c94a97c");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("465bd0fc-608c-4105-9e6a-5d208e533198");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("ca8ad810-0b1c-449c-9e61-ef4729127ed8");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("ade8347e-ed99-48c9-84d6-5eda2423f5ec");
	...
	Наименование.Guid = NsgService.StringToGuid("bb8bad9f-06bb-4c05-947a-9494afec56f6");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("81589896-f9a8-475e-acd6-b0975a768f5f");
	DefaultSortingName = "";
