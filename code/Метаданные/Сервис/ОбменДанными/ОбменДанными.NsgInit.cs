...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "f573e05a-6a2d-4fd7-a9dc-919fa9c22983")]
    public partial class ОбменДанными : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f573e05a-6a2d-4fd7-a9dc-919fa9c22983"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("e33e2a8d-7cf1-4f01-bf5c-097c9c1479d3");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("4e7f38e7-99d7-414d-82ca-d66915b761c9");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("ff9f0716-f9ca-4b34-b18f-020f36ffd228");
	...
	Name = "ОбменДанными";
	Visible = true;
	Guid = NsgService.StringToGuid("f573e05a-6a2d-4fd7-a9dc-919fa9c22983");
	DefaultSortingName = "";
