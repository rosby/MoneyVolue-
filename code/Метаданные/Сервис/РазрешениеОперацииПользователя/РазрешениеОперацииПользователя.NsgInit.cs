...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "eefdc540-388a-463a-b752-18463f332020")]
	...
	Разрешено.GroupName = "";
	Разрешено.Guid = NsgService.StringToGuid("7c25d2a4-65f1-4a69-b1cb-9f3ac56f4d6f");
	...
	Запрещено.GroupName = "";
	Запрещено.Guid = NsgService.StringToGuid("8dded89e-1786-4bca-bee5-7f480a5bd8c5");
	...
	Наследует.GroupName = "";
	Наследует.Guid = NsgService.StringToGuid("b3418f4c-5892-4591-aa19-23d3ccf0d7c4");
	...
	Visible = false;
	Guid = NsgService.StringToGuid("eefdc540-388a-463a-b752-18463f332020");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("eefdc540-388a-463a-b752-18463f332020"));
            if (obj == null)
