...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "094d51f9-14e5-45b8-a871-21627314909e")]
	...
	Оповещение.Guid = NsgService.StringToGuid("a8b23fb5-88bc-40eb-9e41-bd1290c6b65c");
	...
	Предупреждение.Guid = NsgService.StringToGuid("fc4d90ab-d84c-4972-826c-61cfcbfad8a0");
	...
	Напоминание.Guid = NsgService.StringToGuid("dd6524c0-a137-4585-88ad-982602a147cc");
	...
	Name = "ТипСообщения";
	Visible = true;
	Guid = NsgService.StringToGuid("094d51f9-14e5-45b8-a871-21627314909e");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("094d51f9-14e5-45b8-a871-21627314909e"));
            if (obj == null)
