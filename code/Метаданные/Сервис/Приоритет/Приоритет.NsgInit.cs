...
namespace Val.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "d957719c-7ea4-4114-95bc-8603ffd26b82")]
	...
	Минимальный.Guid = NsgService.StringToGuid("fb34e3be-7e1b-44d8-b0b0-9ce966d052d1");
	...
	Низкий.GroupName = "";
	Низкий.Guid = NsgService.StringToGuid("000cba0e-8e86-4070-bb9f-057ade50bab7");
	...
	Средний.GroupName = "";
	Средний.Guid = NsgService.StringToGuid("0d428d5d-1fe4-4ae6-bbd0-a0804ddd80fd");
	...
	Высокий.GroupName = "";
	Высокий.Guid = NsgService.StringToGuid("69d25c45-e04a-4fb8-9c84-28c32a42b1e9");
	...
	Максимальный.Guid = NsgService.StringToGuid("a5e5f2ac-8a51-40be-82dc-ffb14ea98264");
	...
	Name = "Приоритет";
	Visible = true;
	Guid = NsgService.StringToGuid("d957719c-7ea4-4114-95bc-8603ffd26b82");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d957719c-7ea4-4114-95bc-8603ffd26b82"));
            if (obj == null)
                obj = new Приоритет();
