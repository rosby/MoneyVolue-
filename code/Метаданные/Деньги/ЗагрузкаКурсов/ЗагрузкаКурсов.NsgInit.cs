...
namespace Val.Метаданные.Деньги
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "f0892427-02ff-400c-91fe-e5a96cad1858")]
    public partial class ЗагрузкаКурсов : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f0892427-02ff-400c-91fe-e5a96cad1858"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("4e1b1807-82a0-40be-aeef-209c76ce13db");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7f5fd92f-00e4-4386-8374-5164e291dd29");
			...
			#region создание Val.Метаданные.Деньги.ЗагрузкаКурсовФорма Форма
			{  
	...
	Форма.FormClassName = "Val.Метаданные.Деньги.ЗагрузкаКурсовФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("e4d1e6a9-31b3-40cd-b225-4408b7547c12");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание Val.Метаданные.Деньги.ЗагрузкаКурсовФорма Форма
	...
	Name = "ЗагрузкаКурсов";
	Visible = true;
	Guid = NsgService.StringToGuid("f0892427-02ff-400c-91fe-e5a96cad1858");
	DefaultSortingName = "";
	...
	TableName = "Va_report_ZagruzkaKursov";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "ЗагрузкаКурсов";
