...
namespace Val.Метаданные.Деньги
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "080aa76f-418e-4bd8-8cda-814a2a0a4dfd")]
    public partial class Валюты : NsgSoft.DataObjects.NsgDataDictionary
    {
        #region Данные
        ...
        /// </summary>
        protected Валюты(NsgObject obj)
            : base(obj)
        {
        }
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("080aa76f-418e-4bd8-8cda-814a2a0a4dfd"));
            if (obj == null)
                obj = new Валюты();
	...
	Идентификатор.Guid = NsgService.StringToGuid("bb384818-084d-4d1d-a080-5276cb4df2df");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e839a17a-41fd-4ea6-9f7a-0bea6bcc22c7");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("54523d49-922c-4c24-8cd9-ab3984e0d9e9");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("833f71de-6ce1-486e-b145-72ae34a26d15");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("1aefd509-8382-4bf6-a950-06d189bdc468");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("9121606a-134b-4605-81e1-e63d9ef6e9dc");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b813c567-aced-426a-8c87-08198a72e255");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("308c773d-0ff1-46d3-a707-09f36050f656");
	...
	Наименование.Guid = NsgService.StringToGuid("18509f03-71c6-4118-bf6c-05cab354ed0d");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("d1a94705-1895-49d0-a72f-b29cb99e2adc");
	...
	КодВалюты.GroupName = "";
	КодВалюты.Guid = NsgService.StringToGuid("7e3d8284-4843-4a79-89fc-d017a555c612");
	...
	ТекущийКурс.Guid = NsgService.StringToGuid("44ebb9c9-f185-49b5-91bc-df945c51dc5e");
	...
	Name = "Валюты";
	Visible = true;
	Guid = NsgService.StringToGuid("080aa76f-418e-4bd8-8cda-814a2a0a4dfd");
	DefaultSortingName = "";
	...
	GroupName = "Деньги";
        ...
        public new partial class Names// :NsgSoft.DataObjects.NsgDataDictionary.Names
        {
            ...
            /// Код валюты
            /// </summary>
            public static String КодВалюты
            {
                get
                {
                    return "КодВалюты";
            ...
            /// Текущий курс
            /// </summary>
            public static String ТекущийКурс
            {
                get
                {
                    return "ТекущийКурс";
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "Валюты";
                    descriptor.GroupName = "Деньги";
                }
                return descriptor;
            }
            set
        ...
        public System.Int64 КодВалюты
        {
            get
            {
				 NsgDataInteger __КодВалюты = ObjectList["КодВалюты"] as NsgDataInteger;
                 return (System.Int64)__КодВалюты.Value;
            }
            set
            {
                NsgDataInteger __КодВалюты = ObjectList["КодВалюты"] as NsgDataInteger;
                __КодВалюты.Value = value;
            }
        }
        ...
        public System.Decimal ТекущийКурс
        {
            get
            {
				 NsgDataFloat __ТекущийКурс = ObjectList["ТекущийКурс"] as NsgDataFloat;
                 return (System.Decimal)__ТекущийКурс.Value;
            }
            set
            {
                NsgDataFloat __ТекущийКурс = ObjectList["ТекущийКурс"] as NsgDataFloat;
                __ТекущийКурс.Value = value;
            }
        }
        ...
        public Валюты Родитель
        {
            get
            {
                return base.Parent as Валюты;
            }
            set
            {
                base.Parent = value;
        ...
        public new virtual Валюты[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Валюты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Валюты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Валюты[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Валюты(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Валюты Value
            {
                get
                {
                    return (Валюты)base.Value;
                }
                set
                {
                    base.Value = value;
