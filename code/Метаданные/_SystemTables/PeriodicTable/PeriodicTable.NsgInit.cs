...
namespace Val.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "57bce3dc-6748-4224-b102-25c367c59063")]
    public partial class PeriodicTable : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("57bce3dc-6748-4224-b102-25c367c59063"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("e02f2e3a-e21a-439b-9809-56d3d348dc5f");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f841456c-a99f-44d3-9b1f-edb6e5f9a0c0");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("29d3268c-4310-4400-b14a-8d49cc51173e");
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("c1beeb2f-9f29-4742-b275-df055917c79a");
	...
	Значение.GroupName = "";
	Значение.Guid = NsgService.StringToGuid("9a1dce83-cf03-4dcf-9152-1d4688ecfce5");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("75e69203-8c97-4d78-8658-319173f61f54");
	...
	Name = "PeriodicTable";
	Visible = true;
	Guid = NsgService.StringToGuid("57bce3dc-6748-4224-b102-25c367c59063");
	DefaultSortingName = "";
